...
public class PasswordUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Password: password1 = " + encode("password1"));
        System.out.println("Password: password2 = " + encode("password2"));
        System.out.println("Password: password3 = " + encode("password3"));
        System.out.println("Password: password = " + encode("password"));
